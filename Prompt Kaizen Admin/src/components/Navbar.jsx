      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 h-16 flex items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-2.5 shrink-0">
          ...
          <div className="leading-tight">
            <p className="font-bold tracking-tight text-flame-500">
              Prompt Kaizen <span className="inline-flex items-center gap-1 text-flame-900"><ShieldCheck className="w-3.5 h-3.5" />Admin</span>
            </p>
            <p className="text-[10px] uppercase tracking-[0.2em] text-flame-900 font-semibold">Operator Console</p>
          </div>
        </Link>
          ...
          {user && (
            <>
              <div className="hidden sm:flex items-center gap-2 pr-2">
                ...
                <span className="text-sm text-flame-900 hidden lg:inline">{user.name}</span>
              </div>
