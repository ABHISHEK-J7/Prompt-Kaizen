...
// (https://toriiminds.com). No invented shades. The mapping below is
// semantic — `flame` carries the orange brand + cool dark grays for text;
// `cream` carries the white + light gray surfaces.
//
//   #F15D23  Torii brand orange
//   #F15D49  Torii coral (used for hover / secondary)
//   #212529  body text (Bootstrap gray-900)
//   #343a40  dark gray-800
//   #495057  gray-700
//   #6c757d  muted text (gray-600)
//   #bababa  light gray
//   #dee2e6  border default
//   #e5e5e5  light border
//   #f5f5f5  soft gray
//   #f8f9fa  pale section bg
//   #ffffff  / #FFFFFF  white surfaces
//   #121212  dark-mode dark
...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // `flame` = brand orange + cool darks for body text/hero panels.
        // (Light shades intentionally use Torii's neutral grays — Torii has
        // no peach tints; the orange functions as an accent, not a wash.)
        flame: {
          50:  '#f5f5f5',
          100: '#e5e5e5',
          200: '#dee2e6',
          ...
          600: '#F15D49', // hover state — Torii's coral
          700: '#495057',
          800: '#343a40',
          900: '#212529', // body text + dark hero
          950: '#121212',
        },
        cream: {
          50:  '#ffffff',
          100: '#FFFFFF', // BRAND anchor (pure white surface)
          200: '#f8f9fa', // muted section bg
          300: '#f5f5f5', // subtle dividers
          400: '#e5e5e5', // light border
          500: '#dee2e6', // default border
          600: '#bababa',
          700: '#6c757d', // muted text
          800: '#495057',
          900: '#343a40',
        },
      },
